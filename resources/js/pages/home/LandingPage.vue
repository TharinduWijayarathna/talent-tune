...
<template>
    ...
    <div class="min-h-screen bg-background">
            ...
            <div class="container mx-auto px-4 sm:px-6 lg:px-8">
                <div class="flex h-16 items-center justify-between">
                    <Link href="/" class="flex items-center gap-2">
                        <img src="/images/logo.png" alt="TalentTune" class="h-9 w-auto object-contain" />
                    </Link>
        ...
        <section class="relative flex min-h-[90vh] items-center justify-center overflow-hidden py-20 sm:py-32">
            <!-- Animated Background -->
            <div class="absolute inset-0 -z-10">
                <div class="absolute inset-0 bg-gradient-to-br from-primary/10 via-background to-background" />
                <div class="absolute top-0 left-1/4 h-96 w-96 animate-pulse rounded-full bg-primary/5 blur-3xl" />
                <div
            ...
            <div class="relative z-10 container mx-auto w-full px-4 sm:px-6 lg:px-8">
                <div class="mx-auto max-w-5xl text-center">
                    <!-- Badge -->
                    <div class="animate-fade-in mb-8 inline-flex items-center justify-center gap-2 rounded-full border bg-muted/50 px-4 py-1.5 text-sm backdrop-blur"
                        :class="{
                            'translate-y-4 opacity-0': !isVisible,
                            'translate-y-0 opacity-100': isVisible,
                        }" style="transition: all 0.6s ease-out">
                        <Sparkles class="animate-spin-slow h-4 w-4 text-primary" />
                        <span class="font-medium">AI-Powered Viva Management SaaS Platform</span>
                        <Badge variant="secondary" class="ml-2">New</Badge>
                    </div>

                    <!-- Main Heading -->
                    <h1 class="mb-6 text-center text-4xl leading-tight font-bold tracking-tight sm:text-6xl lg:text-7xl"
                        :class="{
                    ...
                    <!-- Description -->
                    <p class="mx-auto mb-10 max-w-3xl text-center text-lg leading-relaxed text-muted-foreground sm:text-xl lg:text-2xl"
                        :class="{
                            'translate-y-8 opacity-0': !isVisible,
                            'translate-y-0 opacity-100': isVisible,
                    ...
                    <!-- CTA Buttons -->
                    <div class="mb-12 flex flex-col items-center justify-center gap-4 sm:flex-row" :class="{
                        'translate-y-8 opacity-0': !isVisible,
                        'translate-y-0 opacity-100': isVisible,
                        ...
                        <Link :href="'/register-institution'">
                            <Button size="lg"
                                ...
                                Register Your University
                                <Building2 class="ml-2 h-4 w-4 transition-transform group-hover:translate-x-1" />
                            </Button>
                        </Link>
                        <!-- Hide login button on main domain -->
                        <Link v-if="!isMainDomain" :href="login()">
                            <Button size="lg" variant="outline" class="w-full border-2 hover:bg-muted/50 sm:w-auto">
                                Sign In
                            </Button>
                        </Link>
                    </div>
                    ...
                    <!-- Stats Preview -->
                    <div class="mx-auto grid max-w-2xl grid-cols-2 gap-4 sm:grid-cols-4" :class="{
                        'translate-y-8 opacity-0': !isVisible,
                        'translate-y-0 opacity-100': isVisible,
                    }" style="transition: all 0.8s ease-out 0.8s">
                        <div class="rounded-lg border bg-muted/30 p-4 text-center backdrop-blur">
            ...
            <!-- Scroll Indicator -->
            <div class="absolute bottom-8 left-1/2 z-10 -translate-x-1/2 transform animate-bounce">
            ...
            <div class="container mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div class="grid gap-8 md:grid-cols-2 lg:grid-cols-3">
                    <Card v-for="(feature, index) in [
                        ...
                        <CardHeader>
                            <div class="mb-4 flex h-12 w-12 items-center justify-center rounded-lg bg-gradient-to-br transition-transform group-hover:scale-110"
                                :class="feature.color">
                                <component :is="feature.icon" class="h-6 w-6 text-white" />
                            </div>
                            <CardTitle class="transition-colors group-hover:text-primary">{{ feature.title }}
                            </CardTitle>
        ...
        <section class="relative overflow-hidden py-20 sm:py-32">
            <!-- Background -->
            <div class="absolute inset-0 bg-gradient-to-b from-muted/40 via-background to-muted/30" />
            <div class="bg-grid-pattern absolute inset-0 opacity-[0.07]" />
            <div class="relative z-10 container mx-auto px-4 sm:px-6 lg:px-8">
                <div class="mx-auto mb-20 max-w-2xl text-center">
                    <Badge variant="outline" class="mb-4 border-primary/30 bg-primary/5 px-3 py-1">Process</Badge>
                    <h2 class="mb-4 text-3xl font-bold tracking-tight sm:text-4xl">
                        How It Works
                    </h2>
                    <p class="text-lg text-muted-foreground">
                ...
                <div class="mx-auto flex max-w-5xl flex-col gap-8 md:flex-row md:items-center md:gap-4">
                    <template v-for="(step, index) in howItWorksSteps" :key="index">
                        ...
                        >
                            <!-- Accent bar top -->
                            <div
                                class="absolute left-0 right-0 top-0 h-1 bg-gradient-to-r opacity-90 transition-opacity group-hover:opacity-100"
                                :class="step.gradient"
                            />
                            <CardHeader class="flex flex-1 flex-col items-center pb-6 pt-8 text-center">
                                <div
                                    ...
                                    :class="[step.gradient]"
                                >
                                    <span class="absolute -right-1 -top-1 flex h-6 w-6 items-center justify-center rounded-full bg-background text-xs font-bold text-foreground shadow ring-2 ring-background">
                                        {{ step.number }}
                                    </span>
                                    <component :is="step.icon" class="h-7 w-7 opacity-95" />
                                </div>
                                <span
                                ...
                                <CardTitle class="text-xl transition-colors group-hover:text-foreground">
                                    {{ step.title }}
                                </CardTitle>
                ...
                <div class="grid items-center gap-12 lg:grid-cols-2">
                    <div>
                        ...
                        <div class="space-y-6">
                            ...
                            ]" :key="index" class="group flex gap-4">
                                ...
                                <div v-for="metric in [
                                    ...
                                    <div class="h-2 overflow-hidden rounded-full bg-muted">
                                        <div class="h-full rounded-full transition-all duration-1000 ease-out"
                                            :class="metric.color" :style="`width: ${metric.value}%`" />
                                    </div>
                                </div>
                            </CardContent>
                        </Card>
        ...
        <section
            ...
            <div class="relative z-10 container mx-auto px-4 sm:px-6 lg:px-8">
                <div class="mx-auto max-w-3xl text-center">
                    <Sparkles class="mx-auto mb-6 h-12 w-12 animate-pulse text-primary-foreground/80" />
                    <h2 class="mb-4 text-3xl font-bold tracking-tight text-primary-foreground sm:text-4xl">
                ...
                <div class="grid gap-8 md:grid-cols-4">
                    <div class="md:col-span-2">
                        <div class="mb-4 flex items-center gap-2">
                            <img src="/images/logo.png" alt="TalentTune" class="h-8 w-auto object-contain" />
                        </div>
                    ...
                    <div>
                        ...
                        <ul class="space-y-2 text-sm text-muted-foreground">
                            <li>
                                <Link href="/register-institution" class="transition-colors hover:text-foreground">
                                    Register Institution</Link>
                            </li>
                            <li>
                                <a href="#" class="transition-colors hover:text-foreground">Features</a>
                            </li>
                            <li>
                                <a href="#" class="transition-colors hover:text-foreground">Pricing</a>
                            </li>
                            <li>
                    ...
                    <div>
                        ...
                        <ul class="space-y-2 text-sm text-muted-foreground">
                            <li>
                                <a href="#" class="transition-colors hover:text-foreground">About</a>
                            </li>
                            <li>
